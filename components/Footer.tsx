      ...
      <footer className="w-full bg-secondary-50 border-t">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="py-14 grid grid-cols-12 gap-x-5 gap-y-8">
            <div className="col-span-full xl:col-span-3 relative bg-gradient-to-tr from-primary-600 to-primary-400 2xl gap-12 p-6 xl:w-72 h-96 flex flex-col justify-center items-center">
              <a
                href="https://pagedone.io/"
                className="flex title text-secondary-50 text-2xl justify-center lg:justify-start"
              >
                TRAILIFY
              </a>
              ...
              <div className="flex  space-x-4 sm:justify-center  ">
                <a
                  href="javascript:;"
                  className="w-9 h-9 rounded-full bg-secondary-50 flex justify-center items-center hover:shadow-md"
                >
                  <svg
